...
//define el Schema del Hospital, es decir, que datos y de que tipo tendra cada uno. Que cosas tendra cada hospital?
const HospitalSchema = Schema({
    ...
    //quiero guardar tb cual es el usuario que genero el hospital. Este sera un tipo de datos particular, que le indicara a Mongoose que vaa haber una relacion entre este Schema de Hospital con el Shema que definido en la propeidad ref, que es el Schema de Usuario
    usuario: {
        required: true,
        type: Schema.Types.ObjectId,
        ref: 'Usuario'
    }
}, {collection: 'hospitales'}) //con este elemento colectio que se mando como segundo eleento en el schema estoy definiendo como quiero que se llame la coleccion en la Base de datos. Aca defino que se va a llamar "hospitales"
